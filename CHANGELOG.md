...
### Added
- **세션 상세 서브탭** — 개요 / 컨텍스트 / Harness 탭 네비게이션 (URL `?tab=`)
- **컨텍스트 탭** — 입력·캐시읽기·캐시생성·출력 토큰 스택 바, 턴별 토큰 분포 테이블, 편집 파일 확장자 바 차트
- **Harness 탭** — 런타임 정보 (디바이스·호스트·OS·클라이언트 버전·모델), 세션 통계, 도구 활동 타임라인
